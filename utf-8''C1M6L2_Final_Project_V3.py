...
def calculate_frequencies(file_contents):
    ...
    for word in file_contents.split():
        for i in word:
            if i.isalpha() is False:
                strings = word.replace(i, "")
        if strings.lower() not in uninteresting_words:
            if strings.lower() in rap_dict:
                rap_dict[strings.lower()] += 1
            rap_dict[strings.lower()] = 1
    ...
    cloud.generate_from_frequencies(rap_dict)
